...
Zu den einzelnen Kategorien gibt es jetzt ausführliche Seiten mit Erklärungen, Kommandos und Tipps:

| Kategorie | Seite |
|-----------|:-----:|
| 🚀 Autonomous AI Agents | [→ Zur Seite](/skills/autonomous-ai-agents) |
| 🎨 Creative | [→ Zur Seite](/skills/creative) |
| 📊 Data Science, ⚙️ DevOps, 🐶 Dogfood, 📧 Email | [→ Zur Seite](/skills/data-devops-email) |
| 🎮 Gaming, 🐙 GitHub | [→ Zur Seite](/skills/gaming-github) |
| 🔌 MCP, 🎵 Media, 🧪 MLOps | [→ Zur Seite](/skills/mcp-media-mlops) |
| 📝 Note-Taking, 🤖 OpenSim NPC, 💼 Productivity | [→ Zur Seite](/skills/notes-npc-productivity) |
| 🔴 Red Teaming, 🔬 Research, 🏠 Smart Home, 📱 Social Media | [→ Zur Seite](/skills/red-research-smart-social) |
| 💻 Software Development, 🌐 Web Development, 💰 Yuanbao | [→ Zur Seite](/skills/dev-web-yuanbao) |
